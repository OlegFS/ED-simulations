...
if __name__ == "__main__":
    ...
    params = {'Vthr': 20,
             ...
             # 'conn':'rand',
              ...
              'b':2}
    all_params = []
    Eps=[0.93]#[0.05,0.1,0.2,0.3,0.5,0.7,0.8,0.93,0.95]# [0.3,0.5,0.8]
    Gs =[7/93]#[9.0,9.0,8/2,7/3,1.0,3/7,2/8,7/93,5/95]#,9.0,4.0,7/3,1.0,3/7,0.25,7/93]#[8/2,1.0,3/7,2/8,5/95]#[7/3,1.0,2/8]
    #Etas = [0.1,0.2,0.3,0.4]
    Taus = [16000]#[5000,20000]#[2000,5000,10000]
    Js =[16.]#[8.5,9.0,10.]# [12.,13.,15.,16.,17.,18.,19.,22.0]#[25.0,15.5,10.0]#[1.0,2.0,2.5,2.8,3.0,4.0]
        ...
        for tau_index, tau in enumerate(Taus):
            for j in Js:
                for ex_rate in ex_rates:
                    for jex in Jexts:
                        for g in [1,0.85,0.8,0.6,0.4,0.3,0.2,0]:
